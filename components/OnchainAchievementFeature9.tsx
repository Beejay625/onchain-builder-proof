...
interface OnchainAchievementFeature9Props {
  achievementId: bigint
}
export default function OnchainAchievementFeature9({ achievementId }: OnchainAchievementFeature9Props) {
  ...
  const submit = () => {
    ...
    writeContract({ address: BUILDER_PROOF_CONTRACT as `0x${string}`, abi: BuilderProofABI, functionName: 'addComment', args: [achievementId, `FEATURE9|data:${data}`] })
  }
