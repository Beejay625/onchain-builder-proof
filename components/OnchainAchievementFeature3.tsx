...
interface OnchainAchievementFeature3Props {
  achievementId: bigint
}
export default function OnchainAchievementFeature3({ achievementId }: OnchainAchievementFeature3Props) {
  ...
  const submit = () => {
    ...
    writeContract({ address: BUILDER_PROOF_CONTRACT as `0x${string}`, abi: BuilderProofABI, functionName: 'addComment', args: [achievementId, `FEATURE3|data:${data}`] })
  }
