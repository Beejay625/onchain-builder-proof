...
interface OnchainAchievementFeature6Props {
  achievementId: bigint
}
export default function OnchainAchievementFeature6({ achievementId }: OnchainAchievementFeature6Props) {
  ...
  const submit = () => {
    ...
    writeContract({ address: BUILDER_PROOF_CONTRACT as `0x${string}`, abi: BuilderProofABI, functionName: 'addComment', args: [achievementId, `FEATURE6|data:${data}`] })
  }
