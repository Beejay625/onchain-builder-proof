...
interface OnchainAchievementFeature7Props {
  achievementId: bigint
}
export default function OnchainAchievementFeature7({ achievementId }: OnchainAchievementFeature7Props) {
  ...
  const submit = () => {
    ...
    writeContract({ address: BUILDER_PROOF_CONTRACT as `0x${string}`, abi: BuilderProofABI, functionName: 'addComment', args: [achievementId, `FEATURE7|data:${data}`] })
  }
