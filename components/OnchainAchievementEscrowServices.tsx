...
export default function OnchainAchievementEscrowServices({ achievementId }: OnchainAchievementEscrowServicesProps) {
  ...
  const record = () => {
    ...
    const payload = `EscrowServices|contract:${contractAddress}|amount:${amount}|participants:${participants}`
    writeContract({
  ...
  return (
    <section className="bg-white border rounded-xl shadow p-6">
      ...
      <p className="text-sm text-gray-600 mb-4">Track EscrowServices operations and configurations.</p>
