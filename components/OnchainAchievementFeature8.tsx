...
interface OnchainAchievementFeature8Props {
  achievementId: bigint
}
export default function OnchainAchievementFeature8({ achievementId }: OnchainAchievementFeature8Props) {
  ...
  const submit = () => {
    ...
    writeContract({ address: BUILDER_PROOF_CONTRACT as `0x${string}`, abi: BuilderProofABI, functionName: 'addComment', args: [achievementId, `FEATURE8|data:${data}`] })
  }
