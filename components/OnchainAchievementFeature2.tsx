...
interface OnchainAchievementFeature2Props {
  achievementId: bigint
}
export default function OnchainAchievementFeature2({ achievementId }: OnchainAchievementFeature2Props) {
  ...
  const submit = () => {
    ...
    writeContract({ address: BUILDER_PROOF_CONTRACT as `0x${string}`, abi: BuilderProofABI, functionName: 'addComment', args: [achievementId, `FEATURE2|data:${data}`] })
  }
