...
interface OnchainAchievementFeature1Props {
  achievementId: bigint
}
export default function OnchainAchievementFeature1({ achievementId }: OnchainAchievementFeature1Props) {
  ...
  const submit = () => {
    ...
    writeContract({ address: BUILDER_PROOF_CONTRACT as `0x${string}`, abi: BuilderProofABI, functionName: 'addComment', args: [achievementId, `FEATURE1|data:${data}`] })
  }
