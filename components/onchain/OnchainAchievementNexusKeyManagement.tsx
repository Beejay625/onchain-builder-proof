...
export default function OnchainAchievementNexusKeyManagement(props: HeliosMeshFeatureProps) {
  return (
    <HeliosMeshComposer
      {...props}
      title="Nexus Key Management"
      subtitle="Key management system for nexus networks"
      accent="purple"
      ctaLabel="Configure Key Management"
      payloadPrefix="NEXUS_KEY_MGMT"
      fields={[
        {
          key: 'systemId',
        ...
        },
        {
          ...
          label: 'Key Policy',
          type: 'textarea',
          placeholder: 'Key management rules and security policies',
        },
      ]}
    />
  )
