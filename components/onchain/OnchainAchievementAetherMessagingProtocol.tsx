...
export default function OnchainAchievementAetherMessagingProtocol(props: HeliosMeshFeatureProps) {
  return (
    <HeliosMeshComposer
      {...props}
      title="Aether Messaging Protocol"
      subtitle="Messaging protocol for aether communications"
      accent="indigo"
      ctaLabel="Deploy Protocol"
      payloadPrefix="AETHER_MSG_PROTOCOL"
      fields={[
        {
          key: 'protocolId',
        ...
        },
        {
          ...
          type: 'textarea',
          placeholder: 'Messaging protocol rules and delivery parameters',
        },
      ]}
    />
  )
