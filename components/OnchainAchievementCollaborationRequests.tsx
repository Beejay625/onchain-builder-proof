...
export default function OnchainAchievementCollaborationRequests() {
  ...
  const requestCollaboration = async () => {
    if (!address || !postId || !collaborator) return
    writeContract({
      address: BUILDER_PROOF_CONTRACT as `0x${string}`,
      abi: BuilderProofABI,
      functionName: 'addComment',
      args: [BigInt(postId), `COLLAB: Request from ${collaborator}`],
    })
  }
