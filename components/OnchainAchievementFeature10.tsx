...
interface OnchainAchievementFeature10Props {
  achievementId: bigint
}
export default function OnchainAchievementFeature10({ achievementId }: OnchainAchievementFeature10Props) {
  ...
  const submit = () => {
    ...
    writeContract({ address: BUILDER_PROOF_CONTRACT as `0x${string}`, abi: BuilderProofABI, functionName: 'addComment', args: [achievementId, `FEATURE10|data:${data}`] })
  }
