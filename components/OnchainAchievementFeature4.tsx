...
interface OnchainAchievementFeature4Props {
  achievementId: bigint
}
export default function OnchainAchievementFeature4({ achievementId }: OnchainAchievementFeature4Props) {
  ...
  const submit = () => {
    ...
    writeContract({ address: BUILDER_PROOF_CONTRACT as `0x${string}`, abi: BuilderProofABI, functionName: 'addComment', args: [achievementId, `FEATURE4|data:${data}`] })
  }
